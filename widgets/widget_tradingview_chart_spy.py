...
SYMBOL_INFO_TEXT = (
    "SPY (AMEX:SPY) — SPDR S&P 500 ETF Trust\n\n"
    "What it is:\n"
    "• An ETF designed to track the S&P 500 (large-cap U.S. equities, market-cap weighted).\n"
    "• Often treated as the primary real-time price of U.S. growth expectations and risk appetite.\n\n"
    "How to read it (macro context):\n"
    "• Uptrend / higher highs: Risk-on regime; easier financial conditions; improving earnings expectations.\n"
    "• Downtrend / lower lows: Risk-off regime; tightening liquidity/credit; growth fears or recession pricing.\n"
    "• Sharp drawdowns + high volatility: Stress / deleveraging; watch credit spreads and Treasury yields.\n"
    "• Sideways range: Uncertainty; market waiting on inflation, rates, or earnings inflection.\n\n"
    "Common interpretation pitfalls:\n"
    "• SPY can rise during weak real economy if liquidity/AI mega-caps dominate.\n"
    "• Always sanity-check against US10Y yields, USD, and credit spreads when moves look 'too clean'."
)

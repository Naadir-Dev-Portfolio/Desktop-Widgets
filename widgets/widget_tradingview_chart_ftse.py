...
SYMBOL_INFO_TEXT = (
    "UK100 (OANDA:UK100GBP) — FTSE 100 Index CFD (GBP)\n\n"
    "What it is:\n"
    "• A CFD tracking the FTSE 100 index (largest 100 companies listed in the UK).\n"
    "• Economically equivalent to the FTSE 100 cash index for trend and direction analysis.\n\n"
    "How to read it (macro context):\n"
    "• Uptrend: Global earnings strength; often supported by commodities, energy, and financials.\n"
    "• Downtrend: Global growth slowdown fears; tightening financial conditions.\n"
    "• Sideways: Macro uncertainty; usually waiting on USD, rates, or global risk cues.\n\n"
    "Key nuance:\n"
    "• FTSE 100 is NOT a pure UK domestic economy gauge.\n"
    "• Revenue exposure is heavily global; moves are driven more by USD, oil, and global risk appetite than UK GDP.\n\n"
    "Why CFD is fine here:\n"
    "• Minor pricing differences vs cash index do not affect trend, regime, or macro interpretation."
)
